    ...
    this.uploader = function(op) {
        ...
        var getNewUpToken = function(file) {
            if (op.uptoken) {
            	...
            	console.log(localStorage.getItem('qiniuToken'));
            	that.token  = localStorage.getItem('qiniuToken');
            //	alert(that.token);
            	return that.token;
//				var userAgent = navigator.userAgent;
//          	var urlArgs = '1.1.0'
//				userAgent = 'MFOrgH5/' + urlArgs + '(' + userAgent + ')';
////				console.log(localStorage.getItem('token'));
////				console.log(userAgent);
//				console.log(op.uptoken_url);
//			    $.ajax({ 
//				  url: op.uptoken_url, 
//				  headers: {
//						'molyfun_user_agent': userAgent,
